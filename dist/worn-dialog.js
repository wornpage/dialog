...
var bi = /* @__PURE__ */ lr("<h2 class=\"worn-dialog-title svelte-qe35nh\"> </h2>"), xi = /* @__PURE__ */ lr("<div class=\"worn-dialog-backdrop svelte-qe35nh\" role=\"presentation\"><div role=\"dialog\" aria-modal=\"true\" tabindex=\"-1\"><div class=\"worn-dialog-head svelte-qe35nh\"><!> <button type=\"button\" class=\"worn-dialog-close svelte-qe35nh\" aria-label=\"Close\"></button></div> <div class=\"worn-dialog-body svelte-qe35nh\"><!></div></div></div>"), Si = {
	hash: "svelte-qe35nh",
	code: ".worn-dialog-backdrop.svelte-qe35nh {position:fixed;inset:0;height:100vh;height:100dvh;box-sizing:border-box;z-index:1000;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.35);backdrop-filter:blur(2px);padding:calc(24px + env(safe-area-inset-top, 0px)) calc(24px + env(safe-area-inset-right, 0px)) calc(24px + env(safe-area-inset-bottom, 0px)) calc(24px + env(safe-area-inset-left, 0px));}.worn-dialog.svelte-qe35nh {box-sizing:border-box;background:var(--worn-surface);border:1px solid var(--worn-border);border-radius:var(--worn-radius);box-shadow:0 16px 48px rgba(0,0,0,0.15);width:460px;max-width:100%;max-height:100%;overflow-y:auto;overscroll-behavior:contain;-webkit-overflow-scrolling:touch;position:relative;}\n	/* CSP-safe: no unsafe-inline for style-src, so size is a static class\n	   (a fixed preset) rather than an inline CSS var. */.worn-dialog.is-sm.svelte-qe35nh {width:360px;}.worn-dialog.is-lg.svelte-qe35nh {width:640px;}.worn-dialog-head.svelte-qe35nh {display:flex;align-items:center;justify-content:space-between;padding:18px 20px 0;}.worn-dialog-title.svelte-qe35nh {font-family:var(--font-family-display);font-size:18px;font-weight:680;color:var(--worn-text);margin:0;min-width:0;overflow-wrap:anywhere;}.worn-dialog-close.svelte-qe35nh {min-width:44px;min-height:44px;position:relative;width:44px;height:44px;border-radius:50%;border:0;background:transparent;color:var(--worn-text-muted);cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0;touch-action:manipulation;}.worn-dialog-close.svelte-qe35nh::before,\n	.worn-dialog-close.svelte-qe35nh::after {content:'';position:absolute;left:50%;top:50%;width:12px;height:1.5px;border-radius:1px;background:currentColor;}.worn-dialog-close.svelte-qe35nh::before {transform:translate(-50%, -50%) rotate(45deg);}.worn-dialog-close.svelte-qe35nh::after {transform:translate(-50%, -50%) rotate(-45deg);}.worn-dialog-close.svelte-qe35nh:hover {background:var(--worn-hover-bg);}.worn-dialog-close.svelte-qe35nh:disabled {cursor:not-allowed;opacity:0.45;}.worn-dialog-close.svelte-qe35nh:focus-visible {outline:2px dashed var(--worn-dialog-focus, var(--worn-focus, currentColor));outline-offset:2px;}.worn-dialog-body.svelte-qe35nh {box-sizing:border-box;min-width:0;max-width:100%;overflow-x:auto;overflow-wrap:anywhere;padding:12px 20px 20px;}\n	@media (max-width: 480px) {.worn-dialog-backdrop.svelte-qe35nh {padding:calc(8px + env(safe-area-inset-top, 0px)) calc(8px + env(safe-area-inset-right, 0px)) calc(8px + env(safe-area-inset-bottom, 0px)) calc(8px + env(safe-area-inset-left, 0px));}\n	}"
};
function Ci(e, t) {
	let n = fr();
	Ge(t, !0), Fr(e, Si);
...
var wi = /* @__PURE__ */ lr("<p class=\"worn-dialog-element-description svelte-w7uukb\"> </p>"), Ti = {
	hash: "svelte-w7uukb",
	code: ".worn-dialog-element-description.svelte-w7uukb {margin:0;color:var(--worn-text-muted);line-height:1.6;overflow-wrap:anywhere;}"
};
function Ei(e, t) {
	Ge(t, !0), Fr(e, Ti);
